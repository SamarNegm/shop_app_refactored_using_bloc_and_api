...
class _profileState extends State<profile> {
  ...
  Future<void> didChangeDependencies() async {
    if (_isInit) {
      ...
      try {
        ...
        // profilePicUrl = Provider.of<Users>(context, listen: false).myUser.image;
  ...
  Widget build(BuildContext context) {
    var productsData; // = Provider.of<Products>(context).items;
    return Scaffold(
        body: Container(
